...
public class SuperCustomToast {
    ...
    public void initView() {
        ...
        mView.setGravity(Gravity.LEFT | Gravity.TOP);//toast location
     ...
     * @param groupMsg 用户组
     */
    public void show(Bitmap face, String name, String groupMsg, int layoutId, int rootId, Activity activity) {
        //LayoutInflater inflater = activity.getLayoutInflater();
        LayoutInflater inflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        layout = inflater.inflate(layoutId,
                (ViewGroup) activity.findViewById(rootId));
        layout.setLayoutParams(lp_WW);
        ImageView face_ = (ImageView) layout.findViewById(R.id.face);
        if (face != null) {
            face_.setImageBitmap(face);
        }
        TextView name_ = (TextView) layout.findViewById(R.id.name);
        if (name != null) {
            name_.setText(name);
        }
        //name_.setTextColor(defaultTextColor);
        TextView groupMsg_ = (TextView) layout.findViewById(R.id.groupMsg);
        if (groupMsg != null) {
            groupMsg_.setText(groupMsg);
        }
        //face_.setTextColor(defaultTextColor);
        show(layout, null, null, null);
    }

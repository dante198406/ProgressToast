...
public class SuperCustomToastActivity extends AppCompatActivity {
    ...
    com.maning.mnprogressdialog.SuperCustomToast toast;
    int i = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toast = com.maning.mnprogressdialog.SuperCustomToast.getInstance(getApplicationContext());
...
//                toast.show(info + i++, 5000);
        ...
        showToast6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ImageView iv = new ImageView(SuperCustomToastActivity.this);
        ...
        showToast7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //toast.show(info + i++, R.layout.super_toast_theme_light, R.id.content_toast, SuperCustomToastActivity.this);
                //toast.show(info, R.layout.super_toast_theme_light, R.id.content_toast, SuperCustomToastActivity.this);
                Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher);
                toast.show(bitmap, "TTT", "Group", R.layout.super_toast_theme_light, R.id.content_toast, SuperCustomToastActivity.this);
            }
        });
